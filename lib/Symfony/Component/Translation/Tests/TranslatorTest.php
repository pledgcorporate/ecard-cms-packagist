...
namespace Ecard\Cms\Dependencies\Symfony\Component\Translation\Tests;

use PHPUnit\Framework\TestCase;
use Ecard\Cms\Dependencies\Symfony\Component\Translation\Exception\RuntimeException;
use Ecard\Cms\Dependencies\Symfony\Component\Translation\Loader\ArrayLoader;
...
class TranslatorTest extends TestCase
{
    ...
    {
        $this->expectException('Ecard\Cms\Dependencies\Symfony\Component\Translation\Exception\InvalidArgumentException');
    ...
    {
        $this->expectException('Ecard\Cms\Dependencies\Symfony\Component\Translation\Exception\NotFoundResourceException');
    ...
    {
        $this->expectException('Ecard\Cms\Dependencies\Symfony\Component\Translation\Exception\RuntimeException');
        $translator = new Translator('en');
        $translator->addResource('array', ['foo' => 'foofoo'], 'en');
    ...
    {
        $translator = new Translator('en_GB');
        $translator->addLoader('yml', new \Ecard\Cms\Dependencies\Symfony\Component\Translation\Loader\YamlFileLoader());
